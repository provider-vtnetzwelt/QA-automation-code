...
public class TestListener implements ITestListener {
	...
	public void onTestFailure(ITestResult result) {
		...
		ExtentODManager.getTestReport().log(Status.FAIL, result.getMethod().getMethodName() + "-Test case failed");
		try {
			ExtentODManager.getTestReport().addScreenCaptureFromPath(
	...
	public void onTestSkipped(ITestResult result) {
		...
		ExtentTest testReport = ExtentODManager.getParentReport().createNode(result.getMethod().getMethodName(),description );
		ExtentODManager.setTestReport(testReport);
		iSkippedCount = iSkippedCount + 1;
		ExtentODManager.getTestReport().log(Status.SKIP, result.getMethod().getMethodName() + "-Test case Skipped");
	...
	public void onTestSuccess(ITestResult result) {
		...
		ExtentODManager.getTestReport().log(Status.PASS, result.getMethod().getMethodName() + "-Test case passed");
	}
